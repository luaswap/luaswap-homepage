...
import StarkWareProvider from './StarkWareProvider';
export default class Authereum extends EventEmitter {
    ...
    private _webUri;
    private _xsUri;
    private _notifierUri;
    private _networkName;
    private _networkId;
    private _redirectUri;
    private _provider;
    private _iframeConnection;
    private _childIframeConnection;
    private _iframe;
    private _notificationIframe;
    private _notifier;
    private _disableNotifications;
    private _cacheReady;
    private _cachedLoginKeyAddress;
    private _cachedAccountAddress;
    private _cachedIsAuthenticated;
    private _iframeReady;
    private _configReady;
    private _iframeConnecting;
    private _readyEmitted;
    private _widgetEnabled;
    private _iframeStyle;
    private _notificationIframeStyle;
    private _blockedPopupRedirect;
    ...
    private _destroyed;
    private _starkProvider;
    private _isPreload;
    private _disableGoogleAnalytics;
    constructor(config?: any);
    private _checkCachedInstance;
    private _merge;
    private _init;
    private _initConfig;
    private _setConfig;
    ...
    private _setupActionKeyListener;
    private _teardownEventListeners;
    private _handleActionKeyPress;
    ...
    signMessage: (...args: any[]) => Promise<unknown>;
    signPersonalMessage: (...args: any[]) => Promise<unknown>;
    signWithDappKey: (...args: any[]) => Promise<unknown>;
    signWithLoginKey: (...args: any[]) => Promise<unknown>;
    signTypedMessage: (...args: any[]) => Promise<unknown>;
    ...
    getSigningKeyAddress: (message: any) => Promise<any>;
    ...
    getCachedNetworkName: () => string;
    getProvider: () => AuthereumProvider;
    getStarkProvider: () => StarkWareProvider;
    ...
    showWidget: (enabled?: boolean) => Promise<boolean>;
    hideWidget: () => Promise<boolean>;
    widgetEnabled: () => boolean;
    addFunds: (opts: any) => Promise<any>;
    private _openUrl;
    ...
    private _heartbeat;
    private _ping;
    private _getOrCreateMainIframe;
    private _constructIframe;
    private _getConfigFromChild;
    private _postVersionToChild;
    private _postConfigToChild;
    private _loadAsymmetricEncryptionKeyFromChild;
    _postMessageToChild: (data: any) => Promise<any>;
    ...
    _setIframePositionLeft: (x: number) => void;
    _setIframeWidth: (width: number) => void;
    _setIframeHeight: (height: number) => void;
    private _refreshWidget;
    private _refreshNotificationWidget;
    ...
    private _getAuthereumPopupWindow;
    private _isAuthereumPopupBlocked;
    _showConfirmPopupOrRedirectModal: () => Promise<any>;
    ...
    _loadNotificationsIframe: (url: string) => Promise<void>;
    _setDebug: (enabled: boolean) => Promise<void>;
}
