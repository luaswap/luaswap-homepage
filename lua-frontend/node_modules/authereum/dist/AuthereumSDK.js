...
class Authereum extends eventemitter3_1.default {
    constructor(config) {
        ...
        this.signMessage = utils_1.throttle((message) => __awaiter(this, void 0, void 0, function* () {
            return this._handleError(this._postMessageToChild({
                method: 'signMessage',
                params: message
            }));
        ...
        this.signTypedMessage = utils_1.throttle((message) => __awaiter(this, void 0, void 0, function* () {
            return this._handleError(this._postMessageToChild({
        ...
        this.destroy = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (this._iframeReady && document.body.contains(this._iframe)) {
