    ...
    <Page>
        ...
        <Box className="mt-4">
            ...
            <StyledInfo>
                ...
                <div>
                <b>Pro Tip</b>: Stake to any pool and earn <b>64x LUA</b> rewards until <a href="https://etherscan.io/block/countdown/11091600" target="_blank" style={{color: '#ffffff'}}>October 20</a>
                </div>
            </StyledInfo>
            <Spacer size="lg" />
            <FarmCards />
