    ...
    <>
      <StyledFarm>
        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
            <StyledInfo>
              ℹ️️ You will earn a portion of the swap fees based on the amount of xLUA held relative the weight of the staking. xLUA can be minted by staking LUA. To redeem LUA staked plus swap fees, convert xLUA back to LUA. There are currently. {totalSupply ? `There are currently ${getBalanceNumber(totalSupply)} xLUA in the whole pool.` : '' }
            </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
        <Spacer size="lg"/>
